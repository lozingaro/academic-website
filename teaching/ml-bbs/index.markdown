...
- **Case Study**: [Predictive Analytics for Customer Retention in a Retail Business](case-study-retail) and the solution [proposed by the instructor](/teaching/ml-bbs/analysis.html).
